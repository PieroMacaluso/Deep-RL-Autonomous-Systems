...
\begin{abstract}
	...
	As researchers discovered, reinforcement learning can be surprisingly useful to solve tasks in simulated environments like games and computer games, and RL showed encouraging performance in tasks with robotic manipulators.
...
Finally, I would like to thank for their constant support my lifelong friends Federico, Davide, Christian, Michele, Jacopo and Pietro.
\begin{flushright}
