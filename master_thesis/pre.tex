\errorcontextlines=9
	...
	\begin{ThesisTitlePage}
		...
		\titolo{A Study of Reinforcement Learning}% per la laurea quinquennale e il dottorato
		\sottotitolo{Reinforcement Learning applied to Autonomous systems}% per la laurea quinquennale e il dottorato
		%
		%%%%%%% Corso degli studi
