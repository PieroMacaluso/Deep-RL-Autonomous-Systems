...
\end{equation}
 ...
 With all the definitions shown so far, it is possible to formalise the type of problems on which \gls{rl} can unleash all its features: the \textbf{\glsdisp{mdp}{Markov Decision Process}}, a mathematic framework to model decision processes. Its main application fields are optimization and dynamic programming.
