...
It is noticeable that this fact does not apply to a real-world scenario like the one we implemented with Cozmo. As discussed in \vref{subsec:timing-actions}, the robot continues also driving during the learning process.
