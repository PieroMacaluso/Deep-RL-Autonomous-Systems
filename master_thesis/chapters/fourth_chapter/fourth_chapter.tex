...
\begin{figure}
    ...
    \scalebox{0.8}{
        ...
        % Text Node
        \draw (329,138) node  [color={rgb, 255:red, 255; green, 255; blue, 255 }  ,opacity=1 ] [align=left] {Action Phase};
        % Text Node
        ...
        \caption[Cozmo algorithm flow chart]{This image shows the flow chart of the system we implemented. The most crucial phases are highlighted in blue. Thi chart is deliberately drawn without an end, because, although there was the possibility, we never set a maximum limit of experiments in Cozmo scenario. It is possible to retrieve the warm-up procedure by answering no to the last two decision branch.}
